<template>
  <div class="order-table-box">
    <p ref="otbServeRef" class="otb-title">
      选择服务
    </p>
    <com-table :url="orderServiceListApi" :query="query"
    ...
    <com-table :url="orderSaleListApi" :init-data="selectedData.orderSale" :columns="columns2"
               :form-config="formConfig2"
               :before-select="onBeforeSelect" @onChange="onOrderSaleChange"
    />
  </div>
</template>
<script>
