<template>
  <div>
    <!-- 选择模板 -->
    <ComGroup title="选择模板" :select-value="selectLayout.name">
    ...
    <!-- 内边距 -->
    <ComGroup title="边距设置">
      <el-radio v-model="paddingDefault" :label="true">
        默认
      </el-radio>
      <el-radio v-model="paddingDefault" :label="false">
        自定义
      </el-radio>
    </ComGroup>
    <div v-if="!paddingDefault">
      <ComGroup title="上下边距">
        <el-slider
          v-model="configData.columnPadding"
          show-input
          :show-input-controls="false"
          input-size="mini"
        />
