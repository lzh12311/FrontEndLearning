<template>
  <div>
    <!-- 添加内容 -->
    <ComGroup title="添加内容" tips="最多添加10条内容，多条将会滚动展示，拖动选中的内容可对其排序" :name-black="true" />
    ...
    <!-- 配置图标 -->
    <ComGroup title="配置图标">
      <el-button type="text" class="mr-15" @click="configData.imageUrl = ''">
        重置
      </el-button>
    ...
    <ComGroup title="文字颜色">
      <el-button type="text" class="mr-15" @click="configData.textColor = initTxtColor">
        重置
      </el-button>
